...
public class FetchLocationService extends FetchVehicleLocationGrpc.FetchVehicleLocationImplBase {

  private VehicleLocationDao locationDao;

  public FetchLocationService(VehicleLocationDao locationDao) {
